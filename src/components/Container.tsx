  ...
  return (
    <div className="container">
        <Card 
            ...
            rewiewTitle="I received a job offer mid-course, and the subjects I learned were current, if not more so, in the company I joined. I honestly feel I got every penny’s worth."
        ...
        <Card 
            ...
            title="Verified Graduate"
            rewiewTitle="The team was very supportive and kept me motivated"
        ...
        <Card 
            ...
            title="Verified Graduate"
            rewiewTitle="An overall wonderful and rewarding experience"
        ...
        <Card 
            name="Patrick Abrams"
            title="Verified Graduate"
            rewiewTitle="Awesome teaching support from TAs who did the bootcamp themselves. Getting guidance from them and learning from their experiences was easy."
        ...
        <Card 
            name="Kira Whittle"
            title="Verified Graduate"
            rewiewTitle="Such a life-changing experience. Highly recommended!"
